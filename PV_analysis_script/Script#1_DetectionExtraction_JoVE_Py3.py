...
#adapted from Weinmann et al., 2020, modified for python 3 and with minor edits to match the peptide display library analysis
#for JoVE article Rapti K. et al., 2022
